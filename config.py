...
MIN_DRAWDOWN = float(os.getenv("MIN_DRAWDOWN", "-15"))
MIN_COMPOSITE_SCORE = float(os.getenv("MIN_COMPOSITE_SCORE", "55"))
TOP_PICKS_COUNT = int(os.getenv("TOP_PICKS_COUNT", "7"))
PRE_FILTER_RSI = float(os.getenv("PRE_FILTER_RSI", "40"))
